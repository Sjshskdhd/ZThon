...
async def zfetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن إنجين أكيوريك 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 2:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن كيفانش تاتليتوغ 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 3:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن شاتاي أولسوي 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 4:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن إنجين ألتان دوزياتان 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 5:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن بوراك أوزجيفت 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 6:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن أراس بولوت إيناملي 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 7:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن گريستيانو رونالدو 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 𓆪 </b> - @A_M_030 "
       return sts_fanan7, caption
    if x == 8:
       caption = f"<b> {FANAN} </b>\n\n\n"
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن سيركان شاي أوغلو 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 9:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن كرم بورسين🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 10:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن توم گــروز🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 11:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن شاهـد گــابور🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 12:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن ليـو ميسـي🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 13:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن محمد حماقي🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 14:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن شَاروخــان🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 15:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن سيـف نبيل🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 16:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن ليوناردو گـابريو 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 17:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن محمد رمـضان🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
    ...
    if x == 18:
       ...
       caption += f"<b> {VANAN} </b>"
       caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
       caption += f"\n\n<b> ✾╎مبࢪوڪ زواجك مِـن سعــد المجرد 🥺💘. </b>"
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 𓆪 </b> - @A_M_030 "
