...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "بالـرد ع اي ملف (يدعم سورس الـجـزار) لـ تنصيبه في بوتك.",
...
async def install(event):
    ...
    zed_dev = (5492061372, 925972505, 5176749470, 5280339206, 5992422584, 6550930943, 6227985448, 5746412340)
