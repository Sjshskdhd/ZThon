...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 - حفـظ الذاتيـه 🧧](t.me/A_M_030) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍](t.me/A_M_030) 𓆪"
)
...
async def oho(event):
    ...
    A_M_0_3 = await event.get_reply_message()
    pic = await A_M_0_3.download_media()
