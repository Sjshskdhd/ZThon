                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @A_M_0_3\
                                  \n\n--------بـدء تتبـع سجـل الـجـزار 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع الـجـزار 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍--------"
                        ...
                        link = "[𐇮 𝞝𝙇𝙂𝘼𝙕𝘼𝙍 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_M_0_3)"
                        text = (
                            "**✘ تقـريـر اشعـار الـجـزار 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار الـجـزار 𝙎𝙊𝙐𝙍𝘾𝞝★𝞝𝙇𝙂𝘼𝙕𝘼𝙍 ✘**\n\n "
                        link = "[𐇮 𝞝𝙇𝙂𝘼𝙕𝘼𝙍 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_M_0_3)"
